...
function move(numberOfSteps, direction) {
    ...
    switch (direction) {
        ...
        case "E":
            ...
            if (temp > 8 || temp < 0) {
                console.log("out of boundray");
                document.write("out of boundray");
            } else {
        ...
        case "SE":
            ...
            if ((temp > 8 || temp < 0) && (temp > 8 || temp < 0)) {
                console.log("out of boundray");
                document.write("out of boundray");
            } else {
                queen.position.x = temp;
...
function play() {
    ...
    console.log("curent postion-->" + board[queen.position.x][queen.position.y])
}